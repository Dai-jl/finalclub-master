...
public class MyclubAdapter1 extends RecyclerView.Adapter<MyclubAdapter1.ViewHolder> {
    ...
    public MyclubAdapter1(List<BeanMyclub> Myclubs){
        myclubs=Myclubs;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        holder.myclub_logo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(v.getContext(), ClubActivity2.class);
                ...
                intent.putExtra("myclub_id",myclub.getCid());
                intent.putExtra("number",myclub.getsNo());
                intent.putExtra("name",myclub.getsName());
                intent.putExtra("header",myclub.getIn());
